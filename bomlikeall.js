...
<meta class="js-ga-set" name="dimension1" content="Logged In">
  ...
  <title>instatools/bomlikeall.js at master · rrudy0966/instatools</title>
  ...
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="145941367" data-scoped-search-url="/rrudy0966/instatools/search" data-unscoped-search-url="/search" action="/rrudy0966/instatools/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper  js-chromeless-input-container">
            <a class="header-search-scope no-underline" href="/rrudy0966/instatools/blob/master/bomlikeall.js">This repository</a>
        <input type="text"
...
<div class="breadcrumb blob-breadcrumb">
  ...
  <strong class="final-path">bomlikeall.js</strong>
</div>
...
<input id="blob-history-checkbox"
       ...
       type="checkbox"
       data-url="/rrudy0966/instatools/latest_commit/master/bomlikeall.js">

<div class="blob-history">
  <a class="js-blob-history-link" href="/rrudy0966/instatools/commits/master/bomlikeall.js">
    Loading latest commit…
</a></div>

<div class="bg-white">
    <div class="blob-file-content js-file-line-container">
      <div class="highlighted-blob tab-size" data-tab-size="8"><div class="code-body highlight"><pre><div class='line js-file-line' id='LC1'><span class="pl-k">const</span> <span class="pl-c1">Client</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>instagram-private-api<span class="pl-pds">&#39;</span></span>).<span class="pl-c1">V1</span>;</div><div class='line js-file-line' id='LC2'><span class="pl-k">const</span> <span class="pl-c1">delay</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>delay<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC3'><span class="pl-k">const</span> <span class="pl-c1">chalk</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>chalk<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC4'><span class="pl-k">const</span> <span class="pl-c1">_</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>lodash<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC5'><span class="pl-k">const</span> <span class="pl-c1">rp</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>request-promise<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC6'><span class="pl-k">const</span> <span class="pl-c1">S</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>string<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC7'><span class="pl-k">const</span> <span class="pl-c1">inquirer</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>inquirer<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC8'><br></div><div class='line js-file-line' id='LC9'><span class="pl-k">const</span> <span class="pl-c1">User</span> <span class="pl-k">=</span> [</div><div class='line js-file-line' id='LC10'>{</div><div class='line js-file-line' id='LC11'>	type<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>input<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC12'>	name<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>username<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC13'>	message<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>[&gt;] Insert Username:<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC14'>	<span class="pl-en">validate</span><span class="pl-k">:</span> <span class="pl-k">function</span>(<span class="pl-smi">value</span>){</div><div class='line js-file-line' id='LC15'>		<span class="pl-k">if</span>(<span class="pl-k">!</span>value) <span class="pl-k">return</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Can<span class="pl-cce">\&#39;</span>t Empty<span class="pl-pds">&#39;</span></span>;</div><div class='line js-file-line' id='LC16'>		<span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC17'>	}</div><div class='line js-file-line' id='LC18'>},</div><div class='line js-file-line' id='LC19'>{</div><div class='line js-file-line' id='LC20'>	type<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>password<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC21'>	name<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>password<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC22'>	message<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>[&gt;] Insert Password:<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC23'>	mask<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>*<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC24'>	<span class="pl-en">validate</span><span class="pl-k">:</span> <span class="pl-k">function</span>(<span class="pl-smi">value</span>){</div><div class='line js-file-line' id='LC25'>		<span class="pl-k">if</span>(<span class="pl-k">!</span>value) <span class="pl-k">return</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Can<span class="pl-cce">\&#39;</span>t Empty<span class="pl-pds">&#39;</span></span>;</div><div class='line js-file-line' id='LC26'>		<span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC27'>	}</div><div class='line js-file-line' id='LC28'>},</div><div class='line js-file-line' id='LC29'>{</div><div class='line js-file-line' id='LC30'>&nbsp;&nbsp;type<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>input<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC31'>&nbsp;&nbsp;name<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>target<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC32'>&nbsp;&nbsp;message<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>[&gt;] Insert Username Target (Without @[at]):<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC33'>&nbsp;&nbsp;<span class="pl-en">validate</span><span class="pl-k">:</span> <span class="pl-k">function</span>(<span class="pl-smi">value</span>){</div><div class='line js-file-line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">if</span>(<span class="pl-k">!</span>value) <span class="pl-k">return</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Can<span class="pl-cce">\&#39;</span>t Empty<span class="pl-pds">&#39;</span></span>;</div><div class='line js-file-line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC36'>&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC37'>},</div><div class='line js-file-line' id='LC38'>{</div><div class='line js-file-line' id='LC39'>&nbsp;&nbsp;type<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>input<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC40'>&nbsp;&nbsp;name<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>mysyntx<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC41'>&nbsp;&nbsp;message<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>[&gt;] Input Total of Target You Want (ITTYW):<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC42'>&nbsp;&nbsp;<span class="pl-en">validate</span><span class="pl-k">:</span> <span class="pl-k">function</span>(<span class="pl-smi">value</span>){</div><div class='line js-file-line' id='LC43'>&nbsp;&nbsp;&nbsp;&nbsp;value <span class="pl-k">=</span> <span class="pl-smi">value</span>.<span class="pl-c1">match</span>(<span class="pl-sr"><span class="pl-pds">/</span><span class="pl-c1">[<span class="pl-c1">0-9</span>]</span><span class="pl-pds">/</span></span>);</div><div class='line js-file-line' id='LC44'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">if</span> (value) <span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC45'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Use Number Only!<span class="pl-pds">&#39;</span></span>;</div><div class='line js-file-line' id='LC46'>&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC47'>},</div><div class='line js-file-line' id='LC48'>{</div><div class='line js-file-line' id='LC49'>&nbsp;&nbsp;type<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>input<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC50'>&nbsp;&nbsp;name<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>sleep<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC51'>&nbsp;&nbsp;message<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&#39;</span>[&gt;] Insert Sleep (MiliSeconds):<span class="pl-pds">&#39;</span></span>,</div><div class='line js-file-line' id='LC52'>&nbsp;&nbsp;<span class="pl-en">validate</span><span class="pl-k">:</span> <span class="pl-k">function</span>(<span class="pl-smi">value</span>){</div><div class='line js-file-line' id='LC53'>&nbsp;&nbsp;&nbsp;&nbsp;value <span class="pl-k">=</span> <span class="pl-smi">value</span>.<span class="pl-c1">match</span>(<span class="pl-sr"><span class="pl-pds">/</span><span class="pl-c1">[<span class="pl-c1">0-9</span>]</span><span class="pl-pds">/</span></span>);</div><div class='line js-file-line' id='LC54'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">if</span> (value) <span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC55'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Delay is number<span class="pl-pds">&#39;</span></span>;</div><div class='line js-file-line' id='LC56'>&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC57'>}</div><div class='line js-file-line' id='LC58'>]</div><div class='line js-file-line' id='LC59'><br></div><div class='line js-file-line' id='LC60'><span class="pl-k">const</span> <span class="pl-c1">Login</span> <span class="pl-k">=</span> <span class="pl-k">async</span> <span class="pl-k">function</span>(<span class="pl-smi">User</span>){</div><div class='line js-file-line' id='LC61'><br></div><div class='line js-file-line' id='LC62'>	<span class="pl-k">const</span> <span class="pl-c1">Device</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Client.Device</span>(<span class="pl-smi">User</span>.<span class="pl-smi">username</span>);</div><div class='line js-file-line' id='LC63'>	<span class="pl-k">const</span> <span class="pl-c1">Storage</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Client.CookieMemoryStorage</span>();</div><div class='line js-file-line' id='LC64'>	<span class="pl-k">const</span> <span class="pl-c1">session</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Client.Session</span>(Device, <span class="pl-c1">Storage</span>);</div><div class='line js-file-line' id='LC65'><br></div><div class='line js-file-line' id='LC66'>	<span class="pl-k">try</span> {</div><div class='line js-file-line' id='LC67'>		<span class="pl-k">await</span> <span class="pl-smi">Client</span>.<span class="pl-smi">Session</span>.<span class="pl-en">create</span>(Device, <span class="pl-c1">Storage</span>, <span class="pl-smi">User</span>.<span class="pl-smi">username</span>, <span class="pl-smi">User</span>.<span class="pl-smi">password</span>)</div><div class='line js-file-line' id='LC68'>		<span class="pl-k">const</span> <span class="pl-c1">account</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-smi">session</span>.<span class="pl-en">getAccount</span>();</div><div class='line js-file-line' id='LC69'>		<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">resolve</span>({session,account});</div><div class='line js-file-line' id='LC70'>	} <span class="pl-k">catch</span> (err) {</div><div class='line js-file-line' id='LC71'>		<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">reject</span>(err);</div><div class='line js-file-line' id='LC72'>	}</div><div class='line js-file-line' id='LC73'><br></div><div class='line js-file-line' id='LC74'>}</div><div class='line js-file-line' id='LC75'><span class="pl-k">const</span> <span class="pl-c1">Target</span> <span class="pl-k">=</span> <span class="pl-k">async</span> <span class="pl-k">function</span>(<span class="pl-smi">username</span>){</div><div class='line js-file-line' id='LC76'>&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">url</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>https://www.instagram.com/<span class="pl-pds">&#39;</span></span><span class="pl-k">+</span>username<span class="pl-k">+</span><span class="pl-s"><span class="pl-pds">&#39;</span>/<span class="pl-pds">&#39;</span></span></div><div class='line js-file-line' id='LC77'>&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">option</span> <span class="pl-k">=</span> {</div><div class='line js-file-line' id='LC78'>&nbsp;&nbsp;&nbsp;&nbsp;url<span class="pl-k">:</span> url,</div><div class='line js-file-line' id='LC79'>&nbsp;&nbsp;&nbsp;&nbsp;method<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">&#39;</span>GET<span class="pl-pds">&#39;</span></span></div><div class='line js-file-line' id='LC80'>&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC81'>&nbsp;&nbsp;<span class="pl-k">try</span>{</div><div class='line js-file-line' id='LC82'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">account</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-en">rp</span>(option);</div><div class='line js-file-line' id='LC83'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">data</span> <span class="pl-k">=</span> <span class="pl-en">S</span>(account).<span class="pl-en">between</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>&lt;script type=&quot;text/javascript&quot;&gt;window._sharedData = <span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span class="pl-pds">&#39;</span>;&lt;/script&gt;<span class="pl-pds">&#39;</span></span>).<span class="pl-smi">s</span></div><div class='line js-file-line' id='LC84'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">json</span> <span class="pl-k">=</span> <span class="pl-c1">JSON</span>.<span class="pl-c1">parse</span>(data);</div><div class='line js-file-line' id='LC85'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">if</span> (<span class="pl-smi">json</span>.<span class="pl-smi">entry_data</span>.<span class="pl-smi">ProfilePage</span>[<span class="pl-c1">0</span>].<span class="pl-smi">graphql</span>.<span class="pl-smi">user</span>.<span class="pl-smi">is_private</span>) {</div><div class='line js-file-line' id='LC86'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">reject</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>Target is private Account<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC87'>&nbsp;&nbsp;&nbsp;&nbsp;} <span class="pl-k">else</span> {</div><div class='line js-file-line' id='LC88'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">id</span> <span class="pl-k">=</span> <span class="pl-smi">json</span>.<span class="pl-smi">entry_data</span>.<span class="pl-smi">ProfilePage</span>[<span class="pl-c1">0</span>].<span class="pl-smi">graphql</span>.<span class="pl-smi">user</span>.<span class="pl-c1">id</span>;</div><div class='line js-file-line' id='LC89'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">const</span> <span class="pl-c1">followers</span> <span class="pl-k">=</span> <span class="pl-smi">json</span>.<span class="pl-smi">entry_data</span>.<span class="pl-smi">ProfilePage</span>[<span class="pl-c1">0</span>].<span class="pl-smi">graphql</span>.<span class="pl-smi">user</span>.<span class="pl-smi">edge_followed_by</span>.<span class="pl-smi">count</span>;</div><div class='line js-file-line' id='LC90'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">resolve</span>({id,followers});</div><div class='line js-file-line' id='LC91'>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC92'>&nbsp;&nbsp;} <span class="pl-k">catch</span> (err){</div><div class='line js-file-line' id='LC93'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">reject</span>(err);</div><div class='line js-file-line' id='LC94'>&nbsp;&nbsp;}</div><div class='line js-file-line' id='LC95'><br></div><div class='line js-file-line' id='LC96'>}</div><div class='line js-file-line' id='LC97'><br></div><div class='line js-file-line' id='LC98'><span class="pl-k">const</span> <span class="pl-c1">Media</span> <span class="pl-k">=</span> <span class="pl-k">async</span> <span class="pl-k">function</span>(<span class="pl-smi">session</span>, <span class="pl-smi">id</span>){</div><div class='line js-file-line' id='LC99'>	<span class="pl-k">const</span> <span class="pl-c1">Media</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Client.Feed.UserMedia</span>(session, id);</div><div class='line js-file-line' id='LC100'><br></div><div class='line js-file-line' id='LC101'>	<span class="pl-k">try</span> {</div><div class='line js-file-line' id='LC102'>		<span class="pl-k">const</span> <span class="pl-c1">Poto</span> <span class="pl-k">=</span> [];</div><div class='line js-file-line' id='LC103'>		<span class="pl-k">var</span> cursor;</div><div class='line js-file-line' id='LC104'>		<span class="pl-k">do</span> {</div><div class='line js-file-line' id='LC105'>			<span class="pl-k">if</span> (cursor) <span class="pl-smi">Media</span>.<span class="pl-c1">setCursor</span>(cursor);</div><div class='line js-file-line' id='LC106'>			<span class="pl-k">const</span> <span class="pl-c1">getPoto</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-smi">Media</span>.<span class="pl-c1">get</span>();</div><div class='line js-file-line' id='LC107'>			<span class="pl-k">await</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">all</span>(<span class="pl-smi">getPoto</span>.<span class="pl-en">map</span>(<span class="pl-k">async</span>(poto) <span class="pl-k">=&gt;</span> {</div><div class='line js-file-line' id='LC108'>				<span class="pl-smi">Poto</span>.<span class="pl-c1">push</span>({</div><div class='line js-file-line' id='LC109'>					id<span class="pl-k">:</span><span class="pl-smi">poto</span>.<span class="pl-c1">id</span>,</div><div class='line js-file-line' id='LC110'>					link<span class="pl-k">:</span><span class="pl-smi">poto</span>.<span class="pl-smi">params</span>.<span class="pl-smi">webLink</span></div><div class='line js-file-line' id='LC111'>				});</div><div class='line js-file-line' id='LC112'>			}))</div><div class='line js-file-line' id='LC113'>			cursor <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-smi">Media</span>.<span class="pl-en">getCursor</span>()</div><div class='line js-file-line' id='LC114'>		} <span class="pl-k">while</span> (<span class="pl-smi">Media</span>.<span class="pl-en">isMoreAvailable</span>());</div><div class='line js-file-line' id='LC115'>		<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">resolve</span>(Poto);</div><div class='line js-file-line' id='LC116'>	} <span class="pl-k">catch</span> (err){</div><div class='line js-file-line' id='LC117'>		<span class="pl-k">return</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">reject</span>(err);</div><div class='line js-file-line' id='LC118'>	}</div><div class='line js-file-line' id='LC119'>}</div><div class='line js-file-line' id='LC120'><br></div><div class='line js-file-line' id='LC121'><span class="pl-k">async</span> <span class="pl-k">function</span> <span class="pl-en">ngeLike</span>(<span class="pl-smi">session</span>, <span class="pl-smi">id</span>){</div><div class='line js-file-line' id='LC122'>	<span class="pl-k">try</span>{</div><div class='line js-file-line' id='LC123'>		<span class="pl-k">await</span> <span class="pl-smi">Client</span>.<span class="pl-smi">Like</span>.<span class="pl-en">create</span>(session, id)</div><div class='line js-file-line' id='LC124'>		<span class="pl-k">return</span> <span class="pl-c1">true</span>;</div><div class='line js-file-line' id='LC125'>	} <span class="pl-k">catch</span>(e) {</div><div class='line js-file-line' id='LC126'>		<span class="pl-k">return</span> <span class="pl-c1">false</span>;</div><div class='line js-file-line' id='LC127'>	}</div><div class='line js-file-line' id='LC128'>}</div><div class='line js-file-line' id='LC129'><br></div><div class='line js-file-line' id='LC130'><span class="pl-k">const</span> <span class="pl-c1">Excute</span> <span class="pl-k">=</span> <span class="pl-k">async</span> <span class="pl-k">function</span>(<span class="pl-smi">User</span>, <span class="pl-smi">TargetUsername</span>, <span class="pl-smi">mysyntx</span>, <span class="pl-smi">sleep</span>){</div><div class='line js-file-line' id='LC131'>	<span class="pl-k">try</span> {</div><div class='line js-file-line' id='LC132'><br></div><div class='line js-file-line' id='LC133'>		<span class="pl-c"><span class="pl-c">/**</span> TRY TO LOGIN *<span class="pl-c">*/</span></span></div><div class='line js-file-line' id='LC134'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(<span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\n</span><span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC135'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>[?] Try to Login . . .<span class="pl-pds">&#39;</span></span>);</div><div class='line js-file-line' id='LC136'>		<span class="pl-k">const</span> <span class="pl-c1">doLogin</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-en">Login</span>(User);</div><div class='line js-file-line' id='LC137'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(chalk<span class="pl-s"><span class="pl-pds">`</span>{bold.green [!] Login Succsess!}<span class="pl-pds">`</span></span>);</div><div class='line js-file-line' id='LC138'><br></div><div class='line js-file-line' id='LC139'>		<span class="pl-c"><span class="pl-c">/**</span> TRY TO GET ALL MEDIA *<span class="pl-c">*/</span></span>	</div><div class='line js-file-line' id='LC140'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>[?] Try to get Media . . .<span class="pl-pds">&#39;</span></span>)		</div><div class='line js-file-line' id='LC141'>		<span class="pl-k">const</span> <span class="pl-c1">getTarget</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-en">Target</span>(TargetUsername);</div><div class='line js-file-line' id='LC142'>		<span class="pl-k">var</span> getMedia <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-en">Media</span>(<span class="pl-smi">doLogin</span>.<span class="pl-smi">session</span>, <span class="pl-smi">getTarget</span>.<span class="pl-c1">id</span>);</div><div class='line js-file-line' id='LC143'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(chalk<span class="pl-s"><span class="pl-pds">`</span>{bold.green [!] Succsess to get Media From [<span class="pl-s1"><span class="pl-pse">${</span>TargetUsername<span class="pl-pse">}</span></span>] }<span class="pl-cce">\n</span><span class="pl-pds">`</span></span>);</div><div class='line js-file-line' id='LC144'>		getMedia <span class="pl-k">=</span> <span class="pl-smi">_</span>.<span class="pl-en">chunk</span>(getMedia, mysyntx);</div><div class='line js-file-line' id='LC145'><br></div><div class='line js-file-line' id='LC146'>		<span class="pl-c"><span class="pl-c">/**</span> TRY TO DELETE ALL MEDIA *<span class="pl-c">*/</span></span></div><div class='line js-file-line' id='LC147'>		<span class="pl-k">for</span> (<span class="pl-k">let</span> i <span class="pl-k">=</span> <span class="pl-c1">0</span>; i <span class="pl-k">&lt;</span> <span class="pl-smi">getMedia</span>.<span class="pl-c1">length</span>; i<span class="pl-k">++</span>) {</div><div class='line js-file-line' id='LC148'>			<span class="pl-en">console</span>.<span class="pl-c1">log</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>[?] Try to Like Photo/Delay <span class="pl-cce">\n</span><span class="pl-pds">&#39;</span></span>)</div><div class='line js-file-line' id='LC149'>			<span class="pl-k">await</span> <span class="pl-c1">Promise</span>.<span class="pl-c1">all</span>(getMedia[i].<span class="pl-en">map</span>(<span class="pl-k">async</span>(media) <span class="pl-k">=&gt;</span> {</div><div class='line js-file-line' id='LC150'>				<span class="pl-k">const</span> <span class="pl-c1">doDelete</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-en">ngeLike</span>(<span class="pl-smi">doLogin</span>.<span class="pl-smi">session</span>, <span class="pl-smi">media</span>.<span class="pl-c1">id</span>);</div><div class='line js-file-line' id='LC151'>				<span class="pl-k">const</span> <span class="pl-c1">PrintOut</span> <span class="pl-k">=</span> chalk<span class="pl-s"><span class="pl-pds">`</span>&gt; <span class="pl-s1"><span class="pl-pse">${</span><span class="pl-smi">media</span>.<span class="pl-c1">link</span><span class="pl-pse">}</span></span> =&gt; <span class="pl-s1"><span class="pl-pse">${</span>doDelete <span class="pl-k">?</span> chalk<span class="pl-s"><span class="pl-pds">`</span>{bold.green Sukses Like}<span class="pl-pds">`</span></span> <span class="pl-k">:</span> chalk<span class="pl-s"><span class="pl-pds">`</span>{bold.red Gagal Like}<span class="pl-pds">`</span></span><span class="pl-pse">}</span></span><span class="pl-pds">`</span></span></div><div class='line js-file-line' id='LC152'>				<span class="pl-en">console</span>.<span class="pl-c1">log</span>(PrintOut);</div><div class='line js-file-line' id='LC153'>			}))</div><div class='line js-file-line' id='LC154'>			<span class="pl-en">console</span>.<span class="pl-c1">log</span>(chalk<span class="pl-s"><span class="pl-pds">`</span>{yellow <span class="pl-cce">\n</span> [#][&gt;] Delay For <span class="pl-s1"><span class="pl-pse">${</span>sleep<span class="pl-pse">}</span></span> MiliSeconds [&lt;][#] <span class="pl-cce">\n</span>}<span class="pl-pds">`</span></span>)</div><div class='line js-file-line' id='LC155'>			    <span class="pl-k">await</span> <span class="pl-en">delay</span>(sleep)</div><div class='line js-file-line' id='LC156'>		}</div><div class='line js-file-line' id='LC157'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pl-en">console</span>.<span class="pl-c1">log</span>(chalk<span class="pl-s"><span class="pl-pds">`</span>{bold.green [+] Bom Like Post Succsess}<span class="pl-pds">`</span></span>)</div><div class='line js-file-line' id='LC158'>	} <span class="pl-k">catch</span> (err) {</div><div class='line js-file-line' id='LC159'>		<span class="pl-en">console</span>.<span class="pl-c1">log</span>(err);</div><div class='line js-file-line' id='LC160'>	}</div><div class='line js-file-line' id='LC161'>}</div><div class='line js-file-line' id='LC162'><span class="pl-en">console</span>.<span class="pl-c1">log</span>(chalk<span class="pl-s"><span class="pl-pds">`</span></span></div><div class='line js-file-line' id='LC163'><span class="pl-s">  {bold.cyan</span></div><div class='line js-file-line' id='LC164'><span class="pl-s">  —————————————————— [INFORMATION] ————————————————————</span></div><div class='line js-file-line' id='LC165'><span class="pl-s">  [?] {bold.green BOM LIKE POST TARGET *SET SLEEP!}</span></div><div class='line js-file-line' id='LC166'><span class="pl-s">  ——————————————————  [THANKS TO]  ————————————————————</span></div><div class='line js-file-line' id='LC167'><span class="pl-s">  [✓] CODE BY CYBER SCREAMER CCOCOT (ccocot@bc0de.net)</span></div><div class='line js-file-line' id='LC168'><span class="pl-s">  [✓] FIXING &amp; TESTING BY SYNTAX (@officialputu_id)</span></div><div class='line js-file-line' id='LC169'><span class="pl-s">  [✓] CCOCOT.CO | BC0DE.NET | NAONLAH.NET | WingkoColi</span></div><div class='line js-file-line' id='LC170'><span class="pl-s">  [✓] SGB TEAM REBORN | Zerobyte.id | ccocot@bc0de.net </span></div><div class='line js-file-line' id='LC171'><span class="pl-s">  —————————————————————————————————————————————————————</span></div><div class='line js-file-line' id='LC172'><span class="pl-s">  What&#39;s new?</span></div><div class='line js-file-line' id='LC173'><span class="pl-s">  1. Input Target/delay Manual (ITTYW)</span></div><div class='line js-file-line' id='LC174'><span class="pl-s">  —————————————————————————————————————————————————————}</span></div><div class='line js-file-line' id='LC175'><span class="pl-s">      <span class="pl-pds">`</span></span>);</div><div class='line js-file-line' id='LC176'><span class="pl-c"><span class="pl-c">//</span>ikiganteng</span></div><div class='line js-file-line' id='LC177'><span class="pl-smi">inquirer</span>.<span class="pl-c1">prompt</span>(User)</div><div class='line js-file-line' id='LC178'>.<span class="pl-c1">then</span>(<span class="pl-smi">answers</span> <span class="pl-k">=&gt;</span> {</div><div class='line js-file-line' id='LC179'>	<span class="pl-en">Excute</span>({</div><div class='line js-file-line' id='LC180'>		username<span class="pl-k">:</span><span class="pl-smi">answers</span>.<span class="pl-smi">username</span>,</div><div class='line js-file-line' id='LC181'>		password<span class="pl-k">:</span><span class="pl-smi">answers</span>.<span class="pl-smi">password</span></div><div class='line js-file-line' id='LC182'>	},<span class="pl-smi">answers</span>.<span class="pl-c1">target</span>,<span class="pl-smi">answers</span>.<span class="pl-smi">mysyntx</span>,<span class="pl-smi">answers</span>.<span class="pl-smi">sleep</span>);</div><div class='line js-file-line' id='LC183'>})</div></pre></div></div>
    </div>
</div>
  ...
  <footer class="clearfix">
    <div class="container">
      ...
      <ul class="clearfix">
        <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-mobile-preference-form" action="/site/mobile_preference" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="dPQc/M1SeMnm2vUajvOPYayG55I0vzAWD48Z8qXcs5WEdLls31Rm+demI0VFeBIbAImeSS309rKIo4Dg7Zrhxw==" />
